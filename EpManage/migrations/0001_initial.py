# Generated by Django 3.0.3 on 2020-03-30 21:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.SmallIntegerField(unique=True, verbose_name='员工编号')),
                ...
                ('department', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='EpManage.Department', verbose_name='所属部门')),
                ('plat', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='EpManage.Plat', verbose_name='所属平台')),
